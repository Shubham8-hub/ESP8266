/*This is  a verified code of Internet Ping Meter using ESP8266(Nodemcu)
 * 
 */
...
const char* ssid     = "shubhamsamal2002";  //enter your ssid
const char* password = "Santosimaa123$";  //enter your wifi password
